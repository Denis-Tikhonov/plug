...
!function (e, t, a, n, r, i, o, s) {
      ...
      function t() {
        ...
        a.css({
          ...
          window.sisi_add_param_ready || (window.sisi_add_param_ready = !0,
            ...
            // --------------------------------------------------------
            // [PARAM: adultjs_debug] v1.2.0-debug — КНОПКА ДИАГНОСТИКИ
            // Добавлено в v1.2.0-debug: триггер запуска проверки источников
            // Для отката: удалить этот блок addParam и функцию AdultJS_Debugger
            // --------------------------------------------------------
            Lampa.SettingsApi.addParam({
              component: "AdultJS",
              param: {
                name: "adultjs_run_debug",
                type: "button",
                values: "",
                default: ""
              },
              field: {
                ...
                description: "Проверить доступность всех источников AdultJS"
              },
              onRender: function (elem) {
                // Назначаем обработчик нажатия кнопки в настройках
  ...
  //   1) Удалить весь блок от [DEBUG_MODULE_START] до [DEBUG_MODULE_END]
  //   2) Удалить addParam "adultjs_run_debug" в секции SETTINGS REGISTRATION
  //   3) Сохранить файл как AdultJS.txt (без -debug суффикса)
  // ============================================================
